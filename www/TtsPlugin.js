cordova.define("com.lefortsoftware.ttsplugin.TtsPlugin", function(require, exports, module) { var exec = require('cordova/exec');
/**
 * Constructor
 */
function TtsPlugin() {}
...
/*
TtsPlugin.prototype.speak = function(successCallBack, failCallBack) {
    exec(function(result){
        successCallBack();
    },
        function(error){
